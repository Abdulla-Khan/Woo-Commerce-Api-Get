class Products {
  ...
  String? salePrice;
  void dateOnSaleFrom;
  void dateOnSaleFromGmt;
  void dateOnSaleTo;
  void dateOnSaleToGmt;
  bool? onSale;
  bool? purchasable;
  int? totalSales;
  bool? virtual;
  ...
  List<void>? defaultAttributes;
  List<void>? variations;
  List<void>? groupedProducts;
  int? menuOrder;
  String? priceHtml;
  List<int>? relatedIds;
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    if (json['upsell_ids'] != null) {
      ...
      json['upsell_ids'].forEach((v) {
        // upsellIds!.add(new void.fromJson(v));
      });
    }
    if (json['cross_sell_ids'] != null) {
      crossSellIds = <Null>[];
      json['cross_sell_ids'].forEach((v) {
        // crossSellIds!.add(void.fromJson(v));
      });
    }
